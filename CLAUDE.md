...
- `docs/` — ドキュメントフォルダ（以下のファイルを格納）
  - `docs/RULEBOOK.md` — ルールブック / 仕様書（**絶対原則**）
...
- `docs/RULEBOOK/` フォルダにルールブックを集約する。
  - `docs/RULEBOOK/CHARTER.md` — 憲章（全バージョン共通の最上位原則）
  - `docs/RULEBOOK/v1.md` — Ver.1.x 系（凍結）
  - `docs/RULEBOOK/v2.md` — Ver.2.x 系（現行）
