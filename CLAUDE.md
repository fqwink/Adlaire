...
| `Adlaire Framework/` | **Adlaire Framework**（バックエンド + フロントエンド） | Ver.1.0 | `Adlaire Framework/rulebookdocs/` |
...
### Adlaire Framework (`Adlaire Framework/`)

Adlaire Group 全プロジェクトに適用する TypeScript 製フルスタック Web フレームワーク。
