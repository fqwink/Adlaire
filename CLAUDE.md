...
- `rulebook-docs/` — ルールブックドキュメントフォルダ（プロジェクトルート）
  - `rulebook-docs/rulebook-charter.md` — ルールブック憲章（全バージョン共通の最上位原則）
  - `rulebook-docs/rulebook-v1.md` — ルールブック Ver.1.x 系（凍結）
  - `rulebook-docs/rulebook-v2.md` — ルールブック Ver.2.x 系（現行）
