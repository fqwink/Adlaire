...
$hook = isset($_REQUEST['hook']) ? basename($_REQUEST['hook']) : '';
$hookContent = '';
if ($hook !== '' && in_array($hook, $allowed_hooks, true) && file_exists(__DIR__ . '/' . $hook)) {
    $hookContent = file_get_contents(__DIR__ . '/' . $hook);
}
?>
