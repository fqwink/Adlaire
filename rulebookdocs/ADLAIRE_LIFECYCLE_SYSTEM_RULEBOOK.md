...
| `ADLAIRE_ARCHITECTURE_RULEBOOK.md` | アーキテクチャ・ファイル構成・セキュリティ |
| `ADLAIRE_API_RULEBOOK.md` | API・データ仕様 |
| `ADLAIRE_DIRECTION_RULEBOOK.md` | 製品方向性 |
| `RULEBOOK_Ver2.md` | リリース計画（バージョンベース） |
