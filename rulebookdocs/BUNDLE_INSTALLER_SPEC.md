...
[Adlaire](https://github.com/fqwink/Adlaire) の公開情報から、リポジトリには `index.php`, `core.php`, `admin.php`, `admin-ui.php`, `.htaccess`, `themes`, `data/lang`, `js/dist`, `package.json`, `tsconfig.json` 等が存在し、PHP本体を中心に、テーマ・言語データ・ビルド済みフロント資産を含む構成であることが確認できる。 [Source](https://github.com/fqwink/Adlaire)
...
| FR-004 | `themes/`, `data/lang/`, `js/dist/` の存在を確認する | MUST |
