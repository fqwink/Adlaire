...
| **Adlaire Framework** | Ver.1.4-9 | 2026-04-12 | パスリテラル型自動推論廃止・禁止化（§0.5追加・ExtractRouteParams/TypedHandler削除） 実装済み |
...
**Ver.1.4-9**（パスリテラル型自動推論廃止・禁止化。§0.5追加・ExtractRouteParams/TypedHandler削除 実装済み）
